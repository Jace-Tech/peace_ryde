    ...
    ;
        ...
        <section class=" new-section2__group layout2" style="background-color: #f8f6f6;">
            <div class="new-section1__cover-block layout">                                       
              ...
              font-size: 18px;
              font-weight: 300;
              ">The first step in applying for a <span style="font-size: 20px; font-weight: 500;">Nigeria Business Incorporation</span> is to fill the form below.<br>
              ...
              <span> move on to the next step to make payment</span>.</p>
                <div style="margin:74px 251px 166px 251px; width: 938px;">
                    <div class="card" style="border:1px solid #ffffff; height: 1290px;">
                        <div style="margin-top: 47px;">
                            ...
                            <p style="
                            padding: 28px 393px 0px 373px;font-family: Ubuntu;font-size: 16px;font-style: normal;font-weight: 400;color: #0A0E69;

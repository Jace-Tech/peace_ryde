                        ...
                        <div>
                            <form>
                                ...
                                <div class="row">
                                  <div class="col-md-5">
                                    <div class="form-group">                                 
                                      <input type="text" required name="companyName" class="form-control firstname2" placeholder="First Name" >
                                  </div>
                                  </div>
                                  <div class="col-md-5">
                                    <div class="form-group">
                                      <input type="text" class="form-control firstname2" required name="email" placeholder="Last Name" >
                                    </div>
                                  </div>
                                </div> 
                              </div>
                              <div class="form-row formml">
                                <div class="row">
                                  <div class="col-md-5">
                                    <label class="mb-2" required name="email" style="margin-top:27px">Personal Email</label>
                                    <div class="form-group">                                 
                              ...
                              <div class="form-row formml">
                                <div class="row">
                                  <div class="col-md-5">
                                    <div class="form-group">                                 
                                      <input type="text" required name="companyName" class="form-control firstname2" placeholder="Company Name" >
                                  </div>
                                  </div>
                                  <div class="col-md-5">
                                    <div class="form-group">                                 
                              ...
                              <div class="form-row formml">
                                <div class="row">
                                  ...
                                  <div class="col-md-5">
                                    <div class="form-group">
                                      <input type="text" class="form-control firstname2" required name="shares" placeholder="No of Shares" >
                                    </div>
                                  </div>
                                </div> 
                              </div>

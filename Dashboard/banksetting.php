    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper" id="main">
            ...
            <div class="page-breadcrumb">
                    ...
                    <div class="align-self-center">
                        <div class="row">                           
                            <div class="">
                                ...
                                font-style: normal;
                                color:#0F1377;
                                padding-top:20px;padding-left:395px
                                ">My Card</h3>
                ...
                <p class="small" style="padding-top:51px;font-family: Ubuntu;
                font-size: 16px;
                padding-left: 51px;
                font-style: normal;
                font-weight: 400;
                color:#1161D9;
                ">Manage your debit/ credit card securely</p>
            </div>      
        ...
        <div style="margin-top:62px">
            <button type="submit" style="height: 60px;margin-left:212px;
            width: 480px;                            
            border-radius: 10px;
            padding: 20px;
            color: #fff;
            background-color: #ADC92E;
            "class="btn btn-button">Add Debit/ Credit Card</button>
        </div>
        <div style="margin-top:34px">
            ...
            "class="btn btn-button">Cancel</button>
        </div>
            <div>

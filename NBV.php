        ...
        <section class=" new-section2__group layout2" style="background-color: #f8f6f6;">
          <div class="new-section1__cover-block layout" style="margin-top:65px">
              <h1 style="font-size: 35px; text-align: center; color: #000080; font-family:Ubuntu">
                  Nigeria Business on Visa Arrival
              </h1>
              <div class="row" style="margin-top:65px">
              
                  <div class="col-md-4" style="margin-left: 246px;">
                      <img src="assets/image_2022-02-25_06-02-55.png" width="413" height="344">
                  </div>
                  
                  <div class="col-md-5">
                      <p style="font-size: 18px;
                      font-family: 'Ubuntu';color: #000080;font-style: normal;font-weight: 300;font-size: 18px;line-height: 35px;letter-spacing: 0.04em;
                      padding-left: 35px; width: 484px; ">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                          Imperdiet
                          dolor donec etiam
                      ...
                      ">See More.....</a></p>
                       <a href="#" class="btn button" style=" margin-top: 23px;margin-left: 35px;
                       width: 117px;
                       height: 43px;
                       padding: 10px 25px;
                   ">Apply</a>

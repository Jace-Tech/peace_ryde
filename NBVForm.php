								...
								<form data-form action="./handlers/form_handler.php" method="post">
										...
										<div class="row">
											<div class="col-md-3">
												<div class="form-group">
													<input type="text" class="form-control firstname" name="firstname" placeholder="First Name (as on passport)">
												</div>
											</div>
											<div class="col-md-3">
												<div class="form-group">
													<input class="form-control middlename" required type="text" name="middlename" placeholder="Middle Name (as on passport)">
												</div>
											</div>
											<div class="col-md-3">
												<div class="form-group" style="margin-right: 117px;">
													<input class="form-control lastname" type="text" name="lastname" placeholder="Last Name (as on passport)">
												</div>
											</div>
										</div>
													...
													<div class="col-md-12" style="margin-top: 25px;">
														...
														<div class="form-check form-check-inline male">
															<div class="custom-control custom-radio">
																...
																<input type="radio" class="custom-control-input" id="customControlValidation2" name="gender" value="male">
															</div>
														</div>
														<div class="form-check form-check-inline" style="margin-left: -20px;">
															<div class="custom-control custom-radio">
																<label class="custom-control-label" for="customControlValidation3">Female</label>
																<input type="radio" class="custom-control-input" id="customControlValidation3" name="gender" value="female">
															</div>
														</div>
													</div>
												</div>
									...
									<div class="form-row formml">
										<div class="row">
											<div class="col-md-5">
												<div class="form-group">
													<input type="email" class="form-control firstname2" required name="email" placeholder="Email address">
												</div>
											</div>
											<div class="col-md-5">
												<div class="form-group">
													<input type="text" class="form-control firstname2" name="passport" required placeholder="Passport No">
												</div>
											</div>
										</div>
									</div>
									...
									<select class="form-select formml select" name="country" aria-label="Default select example">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form method="post" action="./handlers/login.php">
							<div class="form-row">
								<div class="form-group">
									<input type="text" class="form-control" style="border: 1px solid #1161D9; width:470px;font-family:ubuntu;height: 44px; margin-top:27px;  color: #1161D9;" placeholder="Email" name="email" />

									<input type="text" class="form-control" style="border: 1px solid #1161D9; width:470px;font-family:ubuntu;height: 44px; margin-top:27px; color: #1161D9;" placeholder="Password" name="password" />
								</div>
							</div>

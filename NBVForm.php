									...
									<div class="form-row formml">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control firstname" placeholder="First Name (as on passport)">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control middlename" placeholder="Middle Name (as on passport)">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group" style="margin-right: 117px;">
                                                        <input type="text" class="form-control lastname" placeholder="Last Name (as on passport)">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control firstname" placeholder="Date of Birth">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-row formml">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control firstname2" placeholder="Email address">
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control firstname2" placeholder="Passport No">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

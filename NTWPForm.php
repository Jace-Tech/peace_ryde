                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                  <ul class="navbar-nav">
                    ...
                    <li class=" nav-item dropdown">
                      ...
                      style="color: #000000; margin-left:41px; margin-top: 19px;font-family: Ubuntu;
                      font-style: normal;
                      font-weight: 400;
                      font-size: 14.5px;
            ...
            <div class="new-section1__cover-block layout">                                       
                ...
                <div style="margin:74px 251px 166px 251px; width: 938px;">
                    <div class="card" style="border:1px solid #ffffff; height: 999px;">
                        ...
                        <div>
                            <form>
                                <select class="form-select" style="border: 1px solid #555555; width:352px; margin-left:116px; margin-top:72px"
                              ...
                              <div class="form-row" style="margin-left: 116px;">
                                <div class="form-group">                                 
                                    ...
                                    style="border:1px solid #555555; font-family: ubuntu; margin-top: 27px;height: 44px; width:227px;" placeholder="First Name" >
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control"
                                    style="border:1px solid #555555; font-family: ubuntu; margin-top: 27px;height: 44px; width:227px; " placeholder="Middle Name" >
                                </div>
                                <div class="form-group" style="margin-right: 117px;">
                                    <input type="text" class="form-control"
                                    style="border:1px solid #555555; font-family: ubuntu; margin-top: 27px;height: 44px; width:227px;" placeholder="Last Name" >
                                  </div>
                              </div>
                              ...
                              <div class="form-row" style="margin-left: 116px;">
                                <div class="form-group">                                 
                                    <input type="text" class="form-control"
                                    style="border:1px solid #555555; font-family: ubuntu; margin-top: 25px;height: 44px; width:227px;" placeholder="DD/MM/YY" >
                                </div>
                              ...
                              <div class="form-row" style="margin-left: 116px;">
                                <div class="form-group">                                 
                                    <input type="text" class="form-control"
                                    style="border:1px solid #555555; font-family: ubuntu; margin-top: 27px;height: 44px; width:303px;" placeholder="Email address" >
                                </div>
                                
                                <div class="form-group" style="margin-right: 202px;">
                                    <input type="text" class="form-control"
                                    style="border:1px solid #555555; font-family: ubuntu; margin-top: 27px;height: 44px; width:303px;" placeholder="Passport No" >
                                  </div>
                              </div>
                              <div class="form-row" style="margin-left: 116px;">
                                <div class="form-group">
                                  <select class="form-select" style="border: 1px solid #555555; height: 44px;margin-top: 27px; width:303px;font-family: ubuntu;"
                                  aria-label="Default select example">
                                ...
                                <div class="form-group" style="margin-right: 202px;">
                                    <input type="text" class="form-control"
                                    style="border:1px solid #555555; font-family: ubuntu; margin-top: 27px;height: 44px; width:303px;" placeholder="Mobile number" >
                                  </div>
                              </div>      
                              ...
                              <select class="form-select" style="border: 1px solid #555555; height: 44px;margin-left:116px;margin-top: 27px; width:502px;font-family: ubuntu;"
                                  aria-label="Default select example">
                                  <option selected>Please Select</option>
                              ...
                              <div class="form-check form-check-inline" style="padding-left: 0px; padding-top: 3px;">
                                  <div class="custom-control custom-radio">
                                    <label class="custom-control-label" for="customControlValidation2">No</label>
                                      <input type="radio" data-name="no" class="custom-control-input" id="customControlValidation2"
                                          name="twp">
                                  </div>
                              </div>
                              <div class="form-check form-check-inline">
                                  <div class="custom-control custom-radio">
                                    <label class="custom-control-label" for="customControlValidation3">Yes</label>
                                      <input type="radio" data-name="yes" class="custom-control-input" id="customControlValidation3"
                                          name="twp">
                                  </div>
                              </div>
                          </div> 
                            <div style="margin-left: 116px; margin-top:52px">
                                <button type="submit" class="btn proceed" data-btn disabled>Proceed to payment</button>
                            </div>

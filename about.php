              ...
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                      <a class="nav-link link" href="contact.html" style="width: 100%; color: #000000;margin-left:41px; margin-top: 12px;font-family: Ubuntu;
                      font-style: normal;
                      font-weight: 400;
                      font-size: 14px;
                    ...
                    <li class=" nav-item">
                      <a class="nav-link link" href="about.html" style="width: 100%;color: #000000;margin-left:41px; margin-top: 12px;font-family: Ubuntu;
                      font-style: normal;
                      font-weight: 400;
                      font-size: 14px;
            ...
            <section class=" new-section2__group layout2" style="background-color: #f8f6f6;">
                <div class="container new-section1__cover-block layout" style="margin-top: 74px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <img src="assets/image_2022-02-25_06-02-55.png" width="413">
                        </div>
                        <div class="col-md-2"></div>
                        <div class="col-md-4 mt-4">
                            <p style="font-size: 18px; font-family: ubuntu;">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                Imperdiet
                                dolor donec etiam
                    ...
                    <div class="row " style="margin-top:128px;">
                        ...
                        <div class="col-md-2"></div>
                        <div class="col-md-4">
                            <img src="assets/image_2022-02-25_06-02-55.png" width="400">
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="new-section8__block19 layout">
                  ...
                  <div class="container">
                    <div class="row" style="padding-top: 18px;">
                      ...
                      <div class="col-md-2">
                        <p><a href="pp.html" style="font-size: 14px; color: #080C58; text-decoration: none;">Privacy and Cookie
                            Policy</a></p>
                      </div>
                      <div class="col-md-2">

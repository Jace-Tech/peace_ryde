		...
		<main class="new new-main layout">
			...
			<section class=" new-section2__group layout2 aboutpageheight" style="background-color: #f8f6f6;">
				<div class="container new-section1__cover-block layout" style="margin-top: 74px;">
					<h1 style="font-size: 40px; text-align: center; color: #0A0E69; font-family:Ubuntu; margin-bottom: 78px;" class="">
						Who We Are
					</h1>
					<div class="row">
					...
					<h1 style="font-size: 40px; text-align: center; color: #0A0E69; font-family:Ubuntu; margin-top: 78px;" class="">
						Who We Are
					</h1>

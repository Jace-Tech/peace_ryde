                    ...
                    <form>
                        ...
                        <div class="form-row" style="margin-left: 193px;">
                          ...
                          <div class="form-group" style="margin-right: 202px;">
                            <select class="form-select" style="border: 1px solid #555555; width:502px;font-family:ubuntu;height: 44px; margin-top:27px"
                          aria-label="Default select example">
                          <option selected>Country</option>
                          <option value="1">Nigeria Business Visa</option>
                          <option value="2">Nigeria Temporary Work Permit</option>
                          <option value="3">Nigeria Subject to Regularization</option>
                          <option value="4">COVID 19 Payment Support</option>
                        </select>

                    ...
                    <div class="">
                        <div class="card applycard">
                            ...
                            <form method="post" action="">
                                ...
                                <div class="form-row formrowdiv">
                                    <div class="form-group formgroupdiv">
                                        <select class="form-select applyselect" aria-label="Default select example">
                            ...
                            Regularization (STR)
                                            ...
                                            <option value="7">
                                                Permit to Land
                            Immgration Approval For Marine Vessels Foreign Crew
                                            </option>
                                            <option value="8">
                                                Real Estate
                              Cosultancy and
                              ...
                              Brokerage Services
                                            ...
                                            <option value="13">
                                                Nigeria Department of Petroleum Resources (DPR) Permits Consultancy Services
                                            </option>
                                            <option value="14">
                                                Nigeria Maritime and Safety Agency Cabotage Consultancy Services
                                            </option>
                                            <option value="15">Nigeria Ports Authority Consultancy Services</option>
                                            <option value="16">Other Nigerian Government Agencies Consultancy Support Services</option>
                                            <option value="17">
                                                Airport

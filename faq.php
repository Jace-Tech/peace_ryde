            ...
            <section class=" new-section2__group layout2" style="background-color: #f8f6f6;">
                <div class="new-section1__cover-block layout">                    
                    <div style="width: 100%; height: 200px; background-color: #ADC92E;">                      
                      <p style="padding-left: 166px; font-size: 16px; padding-top: 50px;">FAQs</p>
                      <h2 style="padding-left: 166px; font-size: 35px; color: white; font-family: ubuntu;"><b>Help
                        Center</b></h2>
                <p style="padding-left: 166px;font-size: 14px; color: #F1F5F6;">Everything you need to know
                    about your Visa</p>
                  </div>
                    <div >
                        <p
                            style="font-weight: 400; padding-left: 166px; font-size: 20px; font-family: ubuntu; margin-top: 86px; margin-bottom: 72px; color: #000080;">
                            Everything you need to know
                            about processing your
                            Nigerian Visas and payment.<br>Please check the out the friendly team</p>

                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item" style="margin-bottom: 30px;border-radius: 10px;
                            margin-top: 52px; width: 921px; height:64px; margin-left: 166px;">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne"
                                        style="border-radius: 20px; color: #000080; font-size: 18px; font-family: Ubuntu;">
                            ...
                            <div class="accordion-item" style="margin-bottom: 30px;border-radius: 10px;
                            margin-top: 21px; width: 921px; height:64px; margin-left: 166px;">
                      ...
                      <div class="row">
                        <div class="col-md-2">
                          <div class="new-section8__block20 layout">
                            ...
                            <ul>
                              <li style="font-size: 13px;color: #000080;margin-left: 100px;margin-top: 21px;"><img src="assets/instagram.png"
                                  width="16">&nbsp; Instagram
                              </li>
                              
                              <li style="font-size: 13px;color: #000080;margin-left: 100px;margin-top: 31px;"><img src="assets/facebook.png"
                                  width="16">&nbsp; Facebook
                              </li>
                              
                              <li style="font-size: 13px;color: #000080;margin-left: 100px;margin-top: 31px;"><img src="assets/twitter.png"
                                  width="16">&nbsp; Twitter</li>
                            </ul>
                          </div>
                        </div>

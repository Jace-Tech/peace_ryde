                    ...
                    <form>
                        <div class="form-row" style="margin-left: 69px;">
                          ...
                          <div class="form-group" style="margin-right: 202px; margin-top:72px">
                            ...
                            <input type="text" class="form-control" style="border: 1px solid #ffffff; width:470px;font-family:ubuntu;height: 44px; margin-top:12px; background-color: #1161D9; color: #ffffff;" placeholder="Email address provided for your PeaceRyde Africa account"/>                            
                            </div>
                        </div>
                       <div class="row" style="margin-left: 69px; margin-top: 42px;">
                           ...
                           <div class="col-md-6">
                            <div style="margin-bottom:80px ;">
                                <button type="submit" style="width: 173px;" class="btn proceed">RESET PASSWORD</button>
                            </div>
                           </div>
                       </div>

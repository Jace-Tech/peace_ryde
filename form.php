                 ...
                 ">The first step in applying for a <span style="font-size: 20px; font-weight: 500;">Nigeria Temporary Work Permit</span> is to fill the form below.<br>
					...
					<div style="margin:74px 251px 166px 251px; width: 938px;">
						<div class="card" style="border:1px solid #ffffff; height: 999px;">
							...
							<div>
								<form>
									<select class="form-select" style="border: 1px solid #555555; width:352px; margin-left:116px; margin-top:72px" aria-label="Default select example">
										<option selected>Title</option>
										<option value="1">One</option>
										<option value="2">Two</option>
										<option value="3">Three</option>
									</select>
									<p style="padding-top:19px; padding-left: 116px; color: #C8730F;font-family: Ubuntu;
                              font-size: 13px;
                              font-style: normal;
                              font-weight: 400;
                              ...
                              ">Your name must be entered in English as it appears on your passport.</p>
									...
									<div class="form-row" style="margin-left: 116px;">
										<div class="form-group">
											<input type="text" class="form-control" style="border:1px solid #555555; font-family: ubuntu; margin-top: 27px;height: 44px; width:227px;" placeholder="First Name">
										</div>
										<div class="form-group">
											<input type="text" class="form-control" style="border:1px solid #555555; font-family: ubuntu; margin-top: 27px;height: 44px; width:227px; " placeholder="Middle Name">
										</div>
										<div class="form-group" style="margin-right: 117px;">
											<input type="text" class="form-control" style="border:1px solid #555555; font-family: ubuntu; margin-top: 27px;height: 44px; width:227px;" placeholder="Last Name">
										</div>
									</div>

									<div class="form-row" style="margin-left: 116px;">
										<div class="form-group">
											<input type="text" class="form-control" style="border:1px solid #555555; font-family: ubuntu; margin-top: 25px;height: 44px; width:227px;" placeholder="DD/MM/YY">
										</div>
									...
									<div class="form-row" style="margin-left: 116px;">
										<div class="form-group">
											<input type="text" class="form-control" style="border:1px solid #555555; font-family: ubuntu; margin-top: 27px;height: 44px; width:303px;" placeholder="Email address">
										</div>

										<div class="form-group" style="margin-right: 202px;">
											<input type="text" class="form-control" style="border:1px solid #555555; font-family: ubuntu; margin-top: 27px;height: 44px; width:303px;" placeholder="Passport No">
										</div>
									</div>
									<div class="form-row" style="margin-left: 116px;">
										<div class="form-group">
											<select class="form-select" style="border: 1px solid #555555; height: 44px;margin-top: 27px; width:303px;font-family: ubuntu;" aria-label="Default select example">
										...
										<div class="form-group" style="margin-right: 202px;">
											<input type="text" class="form-control" style="border:1px solid #555555; font-family: ubuntu; margin-top: 27px;height: 44px; width:303px;" placeholder="Mobile number">
										</div>
									</div>
									...
									<select class="form-select" style="border: 1px solid #555555; height: 44px;margin-left:116px;margin-top: 27px; width:502px;font-family: ubuntu;" aria-label="Default select example">
										<option selected>Please Select</option>
										<option value="1">One</option>
										<option value="2">Two</option>
										<option value="3">Three</option>

	...
	<?php include("./inc/alert.php"); ?>
          ...
          <section class="">
            <div class="p-2" style="background-color: #1161D9;">
              ...
              <h1 style="font-size: 2rem; text-align: center; color: white; padding-top:90px; font-weight:400; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">
                How does the Visa Process work?
              </h1>
              <h4 style=" text-align: center; color: white; font-family: rubik; padding-top: 13px; font-size: 16px; font-weight: 300;"
                class="">
          ...
          <section class="new-section6__section6 layout">
            <div class="new-section6__flex4 layout">
              ...
              <div class="row reviews2 reviews  mt-99">
                <div class="col-md-2 hide"></div>
                <div class="col-md-3 col-sm-4 mag chee">
                  <div>
                  ...
                  <div class="new-section6__paragraph-body-box layout">
                    <pre class="new-section6__paragraph-body" style="width: 250px;
      ...
      Lorem ipsum dolor sit amet, consectetur adipiscing elit.  </pre>
                ...
                <div class="col-md-3 col-sm-4 mag">
      ...
      Lorem ipsum dolor sit amet, consectetur adipiscing elit.  </pre>
              ...
              <div class="row reviews mt-99 laptopvideo">
                ...
                <div class="col-md-3 mag">
                  <video  loop="" controls="" class="laptopvideo" style="width: 200px;height: 200px; margin-left: -10px; margin-top: -50px;">
             ...
             padding-top:40px;
              ...
              <div class="row reviews mt-99 mobilevideo et">
                ...
                <div class="col-md-3 mag">
                  <video  loop="" controls="" class="mobilevideo" style="width: 200px;height: 200px; margin-left: 0px; margin-top: 0px;">
                    <source type="video/mp4" src="https://endtest-videos.s3-us-west-2.amazonaws.com/documentation/endtest_data_driven_testing_csv.mp4">
                    </video>
                </div>
                ...
                <div class="col-md-3 mag">
                  <video  loop="" controls="" class="mobilevideo" style="width: 200px;height: 200px; margin-left: 0px; margin-top: 30px;">
                    <source type="video/mp4" src="https://endtest-videos.s3-us-west-2.amazonaws.com/documentation/endtest_data_driven_testing_csv.mp4">
                    </video>
                </div>
              </div>
              <button class="btn btn-review" style="border: 1px solid #a0bd1c;  background-color: transparent; color: #a0bd1c;">See More Reviews</button>

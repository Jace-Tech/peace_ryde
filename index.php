	...
	<body class="body">
		<main class="new new-main layout">
			...
			<section class=" new-section1__group layout2">
				...
				<div class="background new-section1__cover-block layout " style="top:145px">
					<div class="movement">
                ...
                Your One-stop shop for </pre>
						...
						<div class="new-section1__block11 layout applys">
							<a href="apply.html" class="btn applybtn">Apply NOW</a>
			...
			<section class="new-section2__section2 layout">
                ...
                justify-content: center;">
									...
									<div class="new-section2__paragraph-body1-box layout">
										<pre class="new-section2__paragraph-body1">Temporary Residence Visas allow individuals reside in Nigeria for a period not exceeding two years. Visas and their brief descriptions are listed below. To view more information on each visa class  validity, etc.)</pre>
									</div>
			...
			<section class="new-section6__section6 layout">
				<div class="new-section6__flex4 layout">
					...
					<div class="row reviews" style="margin-top: 99px;">

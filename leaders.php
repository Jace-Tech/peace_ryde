                ...
                <div class="container new-section1__cover-block layout divcover">
                    <div class="section-team">
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-7 col-lg-6 col-xl-8">
                                    <div class="single-person">
                                        ...
                                        <p class="leadtext">
                                            Socrates Limejuice Bobmanuel is the founder of PeaceRyde Africa LLC, a travel, and tours immigration, and consultancy services company providing a secure and user friendly online digital platform that serves to make processing of business incorporation, and visa services for Nigeria quick, easy, and seamless with just a click of a button.
                                        </p>
                                        <br>
                                        ...
                                        <br>
                                        <span>You may contact Socrates directly
                                            <a class="maillink" href="mailto:socrates@peacerydeafrica.com">socrates@peacerydeafrica.com</a> if you would like a more personalized service experience.
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row lmt">
                                <div class="col-xs-12 col-sm-7 col-lg-6 col-xl-8">
                                    <div class="single-person mobileshow edit">
                                        <div class="person-image">
                                    ...
                                    <div class="single-person">
                                        ...
                                        <br>
                                        <span>You may contact Joy
                                            <a class="maillink" href="mailto:incorporation@peacerydeafrica.com">incorporation@peacerydeafrica.com</a>
                                        </span>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-5 col-lg-6 col-xl-4">
                            ...
                            <div class="row lmt">
                                ...
                                <div class="col-xs-12 col-sm-7 col-lg-6 col-xl-8">
                                    <div class="single-person">
                                        ...
                                        <br>
                                        <p class="leadtext">
                                            As part of the Senior Management Team in UBA, he was highly respected for his dedication, hardwork and unquestionable integrity which made him outstanding amongst his colleagues and was ultimately recognized and rewarded by UBA Management in 2010 CEO award night.
                                        </p>
                                        <br>
                                        ...
                                        <br>
                                        <p class="leadtext">
                                            He holds master’s degree in finance and Banking. Eugene is also an Associate Member of Nigerian Institute of Bankers; Member of Nigerian Institute of Management; Institute of Chartered Accountants of Nigeria and ISO Certified Auditor.
                                        </p>
                                        <br>
                            ...
                            <div class="row lmt">
                                <div class="col-xs-12 col-sm-7 col-lg-6 col-xl-8">
                                    ...
                                    <div class="single-person">
                                        ...
                                        <span>You may contact Daniella
                                            <a class="maillink" href="mailto:billing@peacerydeafrica.com">billing@peacerydeafrica.com</a>
                                        </span>
                            ...
                            <div class="single-person">
                                ...
                                <ul>
                                    <li>
                                        <a class="maillink" href="mailto:visas@peacerydeafrica.com">visas@peacerydeafrica.com</a>
                                    </li>
                                    <li>
                                        <a class="maillink" href="mailto:info@peacerydeafrica.com">info@peacerydeafrica.com</a>
                                    </li>
                                    <li>
                                        <a class="maillink" href="mailto:concierge@peacerydeafrica.com">concierge@peacerydeafrica.com</a>
                                    </li>
                                    <li>
                                        <a class="maillink" href="mailto:support@peacerydeafrica.com">support@peacerydeafrica.com</a>
                                    </li>
                                </ul>

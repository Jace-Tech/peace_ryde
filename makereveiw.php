                    ...
                    <li class=" nav-item dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a class=" dropdown-item" href="NTWP.html"
                            ...
                            Approval</a></li>
                        <li><a class=" dropdown-item" href="VSBForm.html"
                            style="color: black; font-size: 15px; padding-bottom: 10px;">Nigeria
                            Tourist Visa</a></li>
                        <li><a class="dropdown-item" href="VSBForm.html"
                            style="color: black; font-size: 15px; padding-bottom: 10px;">Nigeria
                      ...
                      <ul class="dropdown-menu" style="width: 900px;">
                        <div class="row">
                          <div class="col-md-4">
                            ...
                            <li><a class="dropdown-item" href="SBForm.html"
            ...
            <div class="lastfooter">
              <div class="row lastfooterrow">
                <div class="col-md-3 col-sm-12 col-xs-12">
                  <p><a class="locaddress" href="Index.html"> &copy; &nbsp;
                ...
                <div class="col-md-2">
                  <p style="margin-top: -2px;"><a class="privacy" href="pp.html">Privacy and Cookie
                      Policy</a></p>
                </div>
                <div class="col-md-2">
                  <p><a class="tc" href="t&c.html">Terms & Conditions</a></p>
                </div>
              </div>
            </div>

                        ...
                        <div class="row">
                            <div class="col-md-12" style="margin-bottom: 70px;margin-top: 70px;">
                                ...
                                <p class="pptext2" style="padding-top:8px;padding-bottom:6px;text-align: left;">
                                    ...
                                    <br>
                                    <br>
                                    At PeaceRyde Africa LLC we recognise how much you value your privacy and our aim is to maintain and protect your privacy on our website.
                                    <br>
                                    <br>
                                    Personal information we collect about you includes your full name, gender, title, date of birth, passport number, nationality, email address and phone number (s). We may also collect other information you provide on our website such as your company's name and address, your position in the company, and the company's telephone number. The information we collect about you will be used for the purposes of processing your application.
                                    <br>
                                    <br>
                                    PeaceRyde Africa LLC is fully compliant with the data protection act currently in force in the UK and the EU GDPR.
                                    <br>
                                    <br>
                                    By providing us with your information on our website and through our email, you will be deemed to have read and accepted our privacy policy, and you will be deemed to be consenting to PeaceRyde Africa LLC using your information and passing on your personal data as described in this document.
                                </p>
                                <br>
                                <br>
                                <h1 class="policyh1">
                                    <b>The peacerydeafrica.com website uses cookies</b>
                                </h1>
                                <p class="pptext2" style="padding-top:8px;padding-bottom:6px;text-align: left;">
                                    <br>
                                    <br>
                                ...
                                <p class="pptext2" style="padding-top:8px;padding-bottom:6px;text-align: left;">
                                    <br>
                                    <br>
                                    We use cookie to determine your location and to be able to localize your viewing to your locale. In addition, we use Google Analytics to analyse the use of this website.
                                    <br>
                                    <br>
                                    ...
                                    <br>
                                    <br>
                                    The information generated relating to our website is used to create reports about the use of the website. Google will store this information. Google's privacy policy is available at: http://www.google.com/privacypolicy.htm
                                </p>
                                <br>
                                <br>
                                <h1 class="policyh1">
                                    <b>Cookies and personal information</b>
                                </h1>
                                <p class="pptext2" style="padding-top:8px;padding-bottom:6px;text-align: left;">
                                    <br>
                                    <br>
                                ...
                                <p class="pptext2" style="padding-top:8px;padding-bottom:6px;text-align: left;">
                                    ...
                                    <br>
                                    (a) by email: info@peacerydeafrica.com
                                    <br>
                                    (b) by telephone: +1 (302) 703-9867, +234 (903) 795 5511
                                    <br>
                                    (c) by post to our address: 433 W Harrison St #5409 Chicago, IL 60699 United States of America; 30 Bishop Oluwole Street Victoria Island, Lagos Nigeria.
                                </p>
                                <br>
                                <br>
                                <h1 class="policyh1">

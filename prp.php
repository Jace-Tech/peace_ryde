    ...
    ;
            ...
            <section class=" new-section2__group layout2" style="background-color: #f8f6f6;">
                <div class="new-section1__cover-block layout">
                    ...
                    <div style="width: 100%; height: 278px; background-color: #ADC92E;">                      
                        <h2 style="padding-left: 164px;padding-top: 116px; font-size: 40px; color: white; font-family: ubuntu;"><b>Payment Refund Policy</b></h2>

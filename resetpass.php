...
;
      ...
      <section class=" new-section2__group layout2" style="background-color: #f8f6f6;">
        <div class="new-section1__cover-block layout">
            <h2 style="padding-top:68px;padding-left: 600px;font-family: 'Ubuntu';font-style: normal;font-weight: 500;font-size: 24px;color: #0A0E69;
                        ">Reset Password </h2>
          
            <div class="">
                <div class="card" style="border-radius: 10px;
                border-color: transparent;
                width: 608px; background-color: #1161D9;
                margin: 32px 380px;">
                    ...
                    <form>
                        <div class="form-row" style="margin-left: 69px;">
                          ...
                          <div class="form-group" style="margin-right: 202px; margin-top:72px">
                            <input type="text" class="form-control" style="border: 1px solid #ffffff; width:470px;font-family:ubuntu;height: 44px; margin-top:27px; background-color: #1161D9; color: #ffffff;" placeholder="New Password"/>

                            <input type="text" class="form-control" style="border: 1px solid #ffffff; width:470px;font-family:ubuntu;height: 44px; margin-top:27px; background-color: #1161D9; color: #ffffff;" placeholder="Retype New Password"/>                            
                            </div>
                        </div>
                       <div class="row" style="margin-left: 69px; margin-top: 42px;">
                           ...
                           <div class="col-md-6">
                            <div style="margin-bottom:80px ;">
                                <button type="submit" style="width: 173px;" class="btn proceed">Create Password</button>
                            </div>
                           </div>
                       </div>

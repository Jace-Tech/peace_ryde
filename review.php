...
;
      ...
      <section class=" new-section2__group layout2" style="background-color: #f8f6f6;">
        <div class="new-section1__cover-block layout">
            <h2 style="padding-top:68px;padding-left: 700px;font-family: 'Ubuntu';font-style: normal;font-weight: 500;font-size: 24px;color: #0A0E69;
                        ">Review </h2>
          
            <div class="">
                <div class="card" style="border-radius: 10px;
                border-color: transparent;
                width: 870px; background-color: #ffffff;
                margin: 32px 285px;">                                      
                    <div class="" style="margin-left: 57px;">
                        <div class="form-group" style=" margin-top:45px">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <p style="font-family: Rubik; color:#080C58;
                                    font-size: 16px;
                                    font-weight: 500;
                                    ">Anny Jones</p>
                                    <div class="row">
